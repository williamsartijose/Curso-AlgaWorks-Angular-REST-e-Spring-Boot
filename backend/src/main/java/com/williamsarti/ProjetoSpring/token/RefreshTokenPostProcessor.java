package com.williamsarti.ProjetoSpring.token;
        ...
        ResponseBodyAdvice<OAuth2AccessToken>
{
    ...
    private void removerRefreshTokenDoBody(
        DefaultOAuth2AccessToken token )
    {
        token.setRefreshToken( null );
    }

    private void adicionarRefreshTokenNoCookie(
        String refreshToken,
        ...
        HttpServletResponse resp )
    {
        ...
        refreshTokenCookie.setSecure( false ); // TODO: Mudar para true em
                                               // producao
